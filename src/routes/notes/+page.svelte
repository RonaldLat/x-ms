...
<div class="mx-auto container py-20 px-6">
    ...
    >
        <div class="rounded">
            ...
            >
                ...
                <div class="w-full flex flex-col items-start">
                    ...
                    <div
                        class="flex items-center justify-between text-gray-800 w-full"
                    >
                        <p class="text-sm">March 28, 2020</p>
                        <button
        ...
        <div class="rounded">
            ...
            >
                <div>
                    ...
                    >
                        What does success as a UX designer look like and how to
                        get there systematically
                    </h3>
                </div>
                <div>
                    <div
            ...
            >
                ...
                <div>
                    <div class="mb-3 flex items-center flex-no-wrap">
                        ...
                        <div
                            class="w-6 h-6 bg-cover rounded-md bg-center -ml-2"
                        >
                            <img
        ...
        <div class="rounded">
            ...
            >
                <div>
                    <h3 class="text-gray-800 leading-7 font-semibold w-11/12">
                        What does success as a UX designer look like and how to
                        get there systematically
                    </h3>
                </div>
